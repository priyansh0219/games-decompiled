...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class ContrastStretch : MonoBehaviour
	{
		...
		private void OnRenderImage(RenderTexture source, RenderTexture destination)
		{
			...
			materialApply.SetTexture(ShaderPropertyID._AdaptTex, adaptRenderTex[curAdaptIndex]);
		...
		private void CalculateAdaptation(Texture curTexture)
		{
			...
			materialAdapt.SetTexture(ShaderPropertyID._CurTex, curTexture);
			materialAdapt.SetVector(ShaderPropertyID._AdaptParams, new Vector4(value, limitMinimum, limitMaximum, 0f));
