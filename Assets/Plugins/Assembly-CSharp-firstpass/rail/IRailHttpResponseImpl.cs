...
namespace rail
{
	public class IRailHttpResponseImpl : RailObject, IRailHttpResponse, IRailComponent
	{
		...
		{
			return RAIL_API_PINVOKE.IRailHttpResponse_GetResponseHeaderValue(swigCPtr_, header_key);
		}

		public virtual string GetResponseBodyData()
		{
			return RAIL_API_PINVOKE.IRailHttpResponse_GetResponseBodyData(swigCPtr_);
		}
		...
		{
			return RAIL_API_PINVOKE.IRailHttpResponse_GetContentType(swigCPtr_);
		}

		public virtual string GetContentRange()
		{
			return RAIL_API_PINVOKE.IRailHttpResponse_GetContentRange(swigCPtr_);
		}

		public virtual string GetContentLanguage()
		{
			return RAIL_API_PINVOKE.IRailHttpResponse_GetContentLanguage(swigCPtr_);
		}

		public virtual string GetContentEncoding()
		{
			return RAIL_API_PINVOKE.IRailHttpResponse_GetContentEncoding(swigCPtr_);
		}

		public virtual string GetLastModified()
		{
			return RAIL_API_PINVOKE.IRailHttpResponse_GetLastModified(swigCPtr_);
		}
