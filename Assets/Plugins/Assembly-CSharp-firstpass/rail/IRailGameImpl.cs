...
namespace rail
{
	public class IRailGameImpl : RailObject, IRailGame
	{
		...
		{
			return RAIL_API_PINVOKE.IRailGame_GetBranchBuildNumber(swigCPtr_);
		}
		...
		public virtual RailID GetGamePurchasePalyerRailID()
		{
			IntPtr ptr = RAIL_API_PINVOKE.IRailGame_GetGamePurchasePalyerRailID(swigCPtr_);
