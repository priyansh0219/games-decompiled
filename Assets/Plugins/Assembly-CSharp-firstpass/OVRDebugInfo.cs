...
public class OVRDebugInfo : MonoBehaviour
{
	...
	private void UpdateResolutionEyeTexture()
	{
		...
		float num = (int)(eyeTextureResolutionScale * (eyeRenderDesc.resolution.x + eyeRenderDesc2.resolution.x));
		float num2 = (int)(eyeTextureResolutionScale * Mathf.Max(eyeRenderDesc.resolution.y, eyeRenderDesc2.resolution.y));
