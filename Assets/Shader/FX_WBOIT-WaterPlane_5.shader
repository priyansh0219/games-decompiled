Shader "FX/WBOIT-WaterPlane" {
	Properties {
		...
		_TopFoamHeightOffset ("Foam Height Offset", Float) = -0.1
		_FoamStrength ("Foam Strength", Float) = 1
		_BorderFoam ("Border Foam", Float) = 5
		_BorderFoamStrength ("Border Foam Strength", Float) = 0.5
		_InvFade ("Border Fade Out", Float) = 0.5
		_RefractStrength ("RefractMap Strength", Float) = 0.1
		[Header(Lighting)] _LightingMultiplier ("_LightingMultiplier", Float) = 2
