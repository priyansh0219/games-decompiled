Shader "UWE/Marmoset/Cureball" {
	Properties {
		...
		_VertexStrength ("_VertexStrength", Float) = 0.2
		_RipplesSheet ("RipplesSheet", 2D) = "black" {}
		_RipplesAnimParams ("Ripples U subDiv(x), V subDiv(y), Speed(z)", Vector) = (4,4,1,0)
		_RippleParams ("Ripple normal Strength(x), shade Strength(y), Freq(z), Speed(w)", Vector) = (0.2,0.2,20,0.1)
		_RipplePos1 ("_RipplePos1", Vector) = (0.2,0.2,20,0.1)
		_MovementDir ("_MovementDir", Vector) = (0,0,0,0)
		_Scale ("_Scale", Vector) = (1,1,1,1)
		_Frequency ("_Frequency", Vector) = (15,15,15,15)
		_Fallof ("_Fallof", Float) = 1
		_Strech ("_Strech", Float) = 1
		_InvFade ("Soft Particles Factor", Range(0.01, 100)) = 100
	}
