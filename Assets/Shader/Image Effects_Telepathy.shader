Shader "Image Effects/Telepathy" {
	Properties {
		...
		_RefractStrength ("_RefractStrength", Float) = 0.25
		_FlowMap ("Flow Map", 2D) = "white" {}
		_FlowSpeed ("Flow Speed", Float) = 0.05
		_FlowIntensity ("_FlowIntensity", Float) = 0.05
		_EmperorFaceTex ("_EmperorFaceTex", 2D) = "white" {}
		_ColorCycleSpeed ("_ColorCycleSpeed", Vector) = (0.345,3.63,3.413,1)
	}
