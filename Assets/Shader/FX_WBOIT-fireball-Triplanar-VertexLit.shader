Shader "FX/WBOIT-fireball-Triplanar-VertexLit" {
	Properties {
		...
		_SelfIllumination ("_SelfIllumination", Range(0, 1)) = 0.01
		_LightWrapAround ("LightWrapAround", Range(0, 1)) = 0.15
		_NormalSharpness ("NormalSharpness", Range(0, 1)) = 0.25
		_LightDesaturation ("_LightDesaturation", Range(0, 1)) = 0.7
