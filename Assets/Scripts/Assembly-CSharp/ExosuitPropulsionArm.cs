...
public class ExosuitPropulsionArm : MonoBehaviour, IExosuitArm
{
	...
	[AssertLocalization]
	private const string noItemsMessage = "ExosuitPropulsionCannonNoItems";

	private void Start()
	{
		propulsionCannon.energyInterface = GetComponentInParent<EnergyInterface>();
