...
namespace UnityEngine.PostProcessing
{
	...
	public sealed class DitheringComponent : PostProcessingComponentRenderTexture<DitheringModel>
	{
		...
		public override void Prepare(Material material)
		{
			...
			material.EnableKeyword("DITHERING");
			material.SetTexture(Uniforms._DitheringTex, texture2D);
			material.SetVector(Uniforms._DitheringCoords, new Vector4((float)context.width / (float)texture2D.width, (float)context.height / (float)texture2D.height, value, value2));
		}
	}
}
