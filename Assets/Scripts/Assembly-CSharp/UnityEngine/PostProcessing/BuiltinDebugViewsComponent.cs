...
namespace UnityEngine.PostProcessing
{
	public sealed class BuiltinDebugViewsComponent : PostProcessingComponentCommandBuffer<BuiltinDebugViewsModel>
	{
		...
		private sealed class ArrowArray
		{
		...
		public override bool active
		{
			get
			{
				if (!base.model.IsModeActive(BuiltinDebugViewsModel.Mode.Depth) && !base.model.IsModeActive(BuiltinDebugViewsModel.Mode.Normals) && !base.model.IsModeActive(BuiltinDebugViewsModel.Mode.MotionVectors))
				{
					return base.model.IsModeActive(BuiltinDebugViewsModel.Mode.Culling);
				}
				return true;
			}
		}
		...
		public override void PopulateCommandBuffer(CommandBuffer cb)
		{
			...
			case BuiltinDebugViewsModel.Mode.MotionVectors:
				...
				break;
			case BuiltinDebugViewsModel.Mode.Culling:
			{
				CullingCamera main = CullingCamera.main;
				if (main != null)
				{
					main.DebugRender(cb);
				}
