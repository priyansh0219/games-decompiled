...
namespace UnityEngine.PostProcessing
{
	...
	public class PostProcessingBehaviour : MonoBehaviour
	{
		...
		{
			if (base.enabled && !(profile == null) && !(m_Camera == null) && !m_RenderingInSceneView && m_Taa.active && !profile.debugViews.willInterrupt)
			{
		...
		private void OnRenderImage(RenderTexture source, RenderTexture destination)
		{
			...
			material.SetTexture(ShaderPropertyID._AutoExposure, texture);
			if (num)
			{
				flag = true;
