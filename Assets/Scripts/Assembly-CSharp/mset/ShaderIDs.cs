...
namespace mset
{
	public class ShaderIDs
	{
		...
		public int affectedByDayNightCycle = -1;

		public int outdoors = -1;
		...
		public void Link(string postfix)
		{
			...
			affectedByDayNightCycle = Shader.PropertyToID("_AffectedByDayNightCycle");
			outdoors = Shader.PropertyToID("_Outdoors");
			_valid = true;
		}
	}
}
