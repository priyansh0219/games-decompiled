		...
		public float RestFallPerTick
		{
			get
			{
				...
				case RestCategory.Rested:
					return 1.5833333E-05f * RestFallFactor;
				case RestCategory.Tired:
					return 1.5833333E-05f * RestFallFactor * 0.7f;
				case RestCategory.VeryTired:
					return 1.5833333E-05f * RestFallFactor * 0.3f;
				case RestCategory.Exhausted:
					return 1.5833333E-05f * RestFallFactor * 0.6f;
				default:
					return 999f;
				}
			}
