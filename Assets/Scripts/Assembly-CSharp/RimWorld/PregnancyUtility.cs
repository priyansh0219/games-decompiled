...
namespace RimWorld
{
	public static class PregnancyUtility
	{
		...
		public static float GetPregnancyChanceFactor(this PregnancyApproach mode)
		{
			...
			{
			case PregnancyApproach.AvoidPregnancy:
				return PregnancyChanceFactor_PregnancyApproach_AvoidPregnancy;
			case PregnancyApproach.TryForBaby:
				return PregnancyChanceFactor_PregnancyApproach_TryForBaby;
			default:
				return PregnancyChanceFactor_PregnancyApproach_Normal;
			}
		}
		...
		public static Texture2D GetIcon(this PregnancyApproach mode)
		{
			...
			{
			case PregnancyApproach.AvoidPregnancy:
				return PregnancyApproachIcon_AvoidPregnancy.Texture;
			case PregnancyApproach.TryForBaby:
				return PregnancyApproachIcon_TryForBaby.Texture;
			default:
				return PregnancyApproachIcon_Normal.Texture;
			}
		}
	}
}
