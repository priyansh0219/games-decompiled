...
namespace RimWorld
{
	...
	public class Page_ModsConfig : Page
	{
		...
		private void DoBottomButtons(Rect r)
		{
			...
			if ((Application.platform == RuntimePlatform.WindowsPlayer || Application.platform == RuntimePlatform.WindowsEditor) && widgetRow.ButtonText("OpenModsDataFolder".Translate(), null, drawBackground: true, doMouseoverSound: true, active: true, 150f))
			{
