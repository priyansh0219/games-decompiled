...
namespace Verse
{
	public struct CellRect : IEquatable<CellRect>, IEnumerable<IntVec3>, IEnumerable
	{
		...
		public IntVec3 FarthestPoint(IntVec3 startingPoint, Rot4 direction)
		{
			...
			{
			case 0:
				return new IntVec3(startingPoint.x, 0, maxZ);
			case 1:
				return new IntVec3(maxX, 0, startingPoint.z);
			case 2:
				return new IntVec3(startingPoint.x, 0, minZ);
			case 3:
				return new IntVec3(minX, 0, startingPoint.z);
			default:
