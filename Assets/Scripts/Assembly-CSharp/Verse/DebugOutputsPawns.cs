...
namespace Verse
{
	public static class DebugOutputsPawns
	{
		...
		public static void AnimalCombatBalance()
		{
			...
			float combatPowerCalculated(PawnKindDef pawnKind)
			{
		...
		public static void Mechanoids()
		{
			...
			float combinedHitChance(PawnKindDef k, float distance)
			{
				return weaponHitChance(k, distance) * shooterHitChance(k, distance);
			}
			float shooterHitChance(PawnKindDef k, float distance)
			{
			...
			IEnumerable<string> specialAbilities(PawnKindDef k)
			{
			...
			float weaponHitChance(PawnKindDef k, float distance)
			{
