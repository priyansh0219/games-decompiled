		...
		toil.initAction = ()=>
			{
				...
				{
					driver.workLeft = curJob.bill.GetWorkAmount(uft);
		...
		toil.WithProgressBar(JobDriver_DoBill.BillGiverInd, () =>
			{
                ...
                var totalWork = curJob.bill is Bill_Mech mechBill && mechBill.State == FormingCycleState.Formed ?  
                    Bill_Mech.CompleteBillTicks :
                    curJob.bill.recipe.WorkAmountTotal(uft != null ? uft.Stuff : null);
